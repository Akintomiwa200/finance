...
export default function NewTransactionPage() {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(false);
    if (result) router.push("/cash/transactions");
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">New Transaction</h1>
          <p className="text-muted-foreground mt-1">Record a new income, expense, or transfer</p>
        </div>
      </div>
      ...
      <div className="flex justify-end gap-3">
        <Button variant="outline" onClick={() => router.push("/cash/transactions")} disabled={submitting}>Cancel</Button>
