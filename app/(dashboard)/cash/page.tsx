...
import { ArrowLeftRight, RefreshCw, TrendingUp, Landmark } from "lucide-react";
...
export default function CashPage() {
  return (
    <SectionPage
      ...
      links={[
        { label: "Transactions", href: "/cash/transactions", description: "Record deposits, withdrawals, and transfers", icon: ArrowLeftRight },
